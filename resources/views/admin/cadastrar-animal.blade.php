...
@section('conteudo')
    <div class="d-flex align-items-end justify-content-between mb-4"> <h1 class="h3">Cadastrar Animal</h1>
    </div>

    <form id="form-animal" action="{{ route('animais.store') }}" method="post" enctype="multipart/form-data" class="bg-custom rounded col-12 py-3 px-4">
        @csrf

        <div class="mb-3 row">
            <label for="nome" class="col-sm-2 col-form-label">Nome do Animal:</label>
            <div class="col-sm-10">
                <input  name="nome" :value="old('nome')" required autofocus  type="text" class="form-control bg-dark text-light border-dark" id="nome" >
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input name="especie" :value="old('especie')" required  type="text" class="form-control bg-dark text-light border-dark" id="especie">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control bg-dark text-light border-dark" id="raca" name="raca" required >
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control bg-dark text-light border-dark" id="local" name="local" required >
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control bg-dark text-light border-dark" id="idade" name="idade" required>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control bg-dark text-light border-dark" id="peso" name="peso" required>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control bg-dark text-light border-dark" id="descricao" name="descricao" required>
    ...
    <div class="col-sm-10">
        <select name="status" class="form-select bg-dark text-light border-dark" id="status" required>
        ...
        <div class="d-flex justify-content-end">
            <button type="submit" class="btn btn-light" id="enviar">Cadastrar Animal</button>
        </div>
    </form>
